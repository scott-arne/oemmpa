...
def write_provenance_manifest(out_path: Path, count: int, fixture_sha256: str) -> None:
...
def main() -> None:
    ...
    # Fail-closed source guard: reject proprietary file paths.
    ...
    write_provenance_manifest(out_path, len(rows), fixture_sha256)
